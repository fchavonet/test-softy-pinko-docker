...
<details>
    <summary>
        <b>0. Create Your First Docker Image</b>
    </summary>
    <br>
...
<img src="./assets/images/screenshot-task1.png" alr="Task 1 screenshot">
...
<img src="./assets/images/screenshot-task2.png" alt="Task 2 screenshot">
...
<details>
    <summary>
        <b>3. Connecting the Front-end and Back-end</b>
    </summary>
    <br>
...
<img src="./assets/images/screenshot-task3.png" alt="Task 3 screenshot">
...
<details>
    <summary>
        <b>4. Making it Simpler with Docker Compose</b>
    </summary>
    <br>
...
| `task6`    | Scaled back-end horizontally with load balancing.       | 
...
```
git clone https://github.com/fchavonet/test-softy-pinko-docker.git
```
...
4. The container will output `Hello, World!`.
...
4. Open your navigator and go to [http://localhost:5252/api/hello](http://localhost:5252/api/hello).
...
4. Open your navigator and go to [http://localhost:9000](http://localhost:9000).
...
2. uild and run the back-end container:
...
3. Build and run the front-end container:
...
3. Open your navigator and go to [http://localhost:9000](http://localhost:9000).
...
3. Open your navigator and go to [http://localhost:80](http://localhost:80).
...
2. Build and scale the back-end with Docker Compose:
